...
(function() {
    var extensions = {
         ...
         *
         * @example Loop over all function arguments
         * function foo() {
         *   arguments.toArray().forEach(function() {
         *     console.log(this);
         *   });
         * }
         *
         * @todo make sure this does not mess up a native toArray function, if
         *   it exists. If so, consider another name to prevent confusion.
         * @return <Array>
         */
        toArray: function() {
